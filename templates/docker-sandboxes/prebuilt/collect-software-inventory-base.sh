...
printf 'artifactKind\tdocker-sandboxes-template-base\n'
...
for key in ('backend', 'policy', 'release', 'sourceIndexDigest', 'sourceManifestDigest', 'qemuVersion'):
    print(f"{key}\t{emulation[key]}")
PY
