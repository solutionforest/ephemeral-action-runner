...
Before planning or changing provider, startup, configuration, pool, runner-image, or lifecycle behavior, read [Development and Extension Principles](docs/development-principles.md), [Contributing](CONTRIBUTING.md), [Design](docs/design.md), and [Adding a Provider](docs/providers/adding-provider.md).
